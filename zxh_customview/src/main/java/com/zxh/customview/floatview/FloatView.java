...
//        hide();
    ...
    private View createView(final Context context) {
        ...
        // 从布局文件获取浮动窗口视图
        rootFloatView = inflater.inflate(R.layout.widget_float_view, null);
        ...
        rootFloatView.setOnLongClickListener(new OnLongClickListener() {
            @Override
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mIvFloatLogo.setImageResource(R.drawable.icon_float_view_voice);
                mWmParams.alpha = 1f;
                if(isHide){
...
//                            +" y = "+mFlFloatLogo.getY());
    ...
    private void refreshFloatMenu(boolean right) {
        ...
        if (right) {
            paramsMenuAccount.rightMargin = getResources().getDrawable(R.drawable.icon_float_view_voice).getIntrinsicWidth()-6;//+6
            ...
            paramsMenuAccount.leftMargin = getResources().getDrawable(R.drawable.icon_float_view_voice).getIntrinsicWidth()+6;
